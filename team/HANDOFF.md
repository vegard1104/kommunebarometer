...
|---|---|---|---|---|---|
| Pakke 3a | Vegard / Backend | **Hent ekte 2024-DKI fra Grønt hefte 2025 + utvid til alle 357 kommuner.** Excel-POC dekker bare Lørenskog (3222) for 2025; 2024-fila approksimerer med samme tall. Reell innhenting krever nedlasting av KMD Grønt hefte 2025 (Excel-vedlegg på regjeringen.no), parsing av delkostnadsindeks-arket per kommune, og generering av komplett `data/dki-2024.json` + `data/dki-2025.json`. Sjekk at sektorvekter (delkostnadsnøkler) er aktuelle for året. | `data/dki-2025.json`, `data/dki-2024.json`, branch `feature/a2-dki-data`, KMD: https://www.regjeringen.no/no/tema/kommuner-og-regioner/kommuneokonomi/inntektssystemet-for-kommuner-og-fylkeskommuner/id551623/ | Nei | 2026-04-25 |
...
|---|---|---|---|---|
| Backend | Prosjektleder | **Pakke 3a (feature/a2-dki-data) — DKI POC for Lørenskog.** `data/dki-2024.json` + `data/dki-2025.json` med 7 sektorer for Lørenskog. `scripts/test-dki.mjs` validerer sektorvekter sum=1,0 og vektet DKI=0,9479. POC — utvidelse til alle 357 kommuner åpen som HANDOFF. | `data/dki-2024.json`, `data/dki-2025.json`, `scripts/test-dki.mjs`, branch `feature/a2-dki-data` | 2026-04-25 |
