...
|---|---|---|---|---|
| Frontend | Prosjektleder | **Pakke 3b (feature/a2-behovsjustert-visning) — A2 toggle + DKI-justert scoring.** Toggle Rådata/Behovsjustert i toolbar. URL-state + localStorage. DKI-badge på sektorkort med klartekst-tooltip. Whitelist for kostnadsindikatorer. Re-beregner instant uten ny SSB-fetch. | `index.html`, `data/behovsjustering-readme.md`, branch `feature/a2-behovsjustert-visning` | 2026-04-25 |
