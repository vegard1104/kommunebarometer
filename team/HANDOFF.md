...
|---|---|---|---|---|
| Frontend | Prosjektleder | **Pakke 5 (feature/forside-klikkbare-sektorer) — Klikkbare sektor-kort.** Hvert sektor-kort er nå `<a>`-lenke til sektor.html med kommune+år+mode i URL. ARIA-label, focus-visible, hover/transform, touch-target ≥ 130px. | `index.html`, branch `feature/forside-klikkbare-sektorer` | 2026-04-25 |
