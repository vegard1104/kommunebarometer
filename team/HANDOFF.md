...
|---|---|---|---|---|
| Frontend | Prosjektleder | **Pakke 4 (feature/sektor-dypdykk-alle-12) — Parameterisert sektor.html.** Én fil dekker alle 12 sektorer via ?id=. Header, DKI-panel m/forklaring, eksterne kilde-lenker per sektor, SSB-referanse. Indikator-tabell + tidsserie flagget som "kommer i fase 2". | `sektor.html`, `data/dki-*.json`, branch `feature/sektor-dypdykk-alle-12` | 2026-04-25 |
